(async () => {
  try {
    const res = await fetch('http://localhost:3001/api/v1/pmo/tasks/ee920a81-b357-4fe1-84bd-a34d3e47e26c', {
      method: 'PATCH',
      headers: {
      ...
      body: JSON.stringify({ fechaInicio: '2026-07-01', fechaFin: '2026-07-10' }),
    });
